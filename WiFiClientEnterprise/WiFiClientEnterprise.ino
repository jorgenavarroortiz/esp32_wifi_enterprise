...
const char *host = "artscene.textfiles.com"; //external server domain for HTTP connection after authentication
int counter = 0;
...
void loop() {
  ...
  if (client.connect(host, 80)) {
    String url = "/asciiart/another_dragon";
    ...
    while(client.available()){
      String line = client.readStringUntil('\r'); //    String
      Serial.println(line); 
    }
  } else {
